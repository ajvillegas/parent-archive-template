...
This plugin allows you to display an archive of child pages on the parent page when when selecting the 'Parent Archive' page template. **Requires the Genesis Framework**.
